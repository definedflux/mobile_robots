...
#ifndef DDBOT_MSGS__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
#define DDBOT_MSGS__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
 ...
 * calls
 * ddbot_msgs__srv__GetTransform_Request__init().
...
/**
 * It calls
 * ddbot_msgs__srv__GetTransform_Request__fini()
 ...
 * ddbot_msgs__srv__GetTransform_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ddbot_msgs__srv__GetTransform_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ddbot_msgs__srv__GetTransform_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ddbot_msgs
...
/**
 * It calls
 * ddbot_msgs__srv__GetTransform_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ddbot_msgs
...
/**
 * It allocates the memory for the array and calls
 * ddbot_msgs__srv__GetTransform_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ddbot_msgs
...
/**
 * It calls
 * ddbot_msgs__srv__GetTransform_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DDBOT_MSGS__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
