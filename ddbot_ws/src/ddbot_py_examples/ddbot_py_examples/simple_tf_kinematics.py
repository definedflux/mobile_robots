...
from ddbot_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "ddbot_base"
        self.static_transform_stamped_.child_frame_id = "ddbot_top"
        ...
        self.orientation_increment_ = quaternion_from_euler(0, 0, 0.0314)
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "ddbot_base"
